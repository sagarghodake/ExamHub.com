			...
			<div class="row clearfix">
				<div class="col-lg-12">
					...
					<div class="card">
						...
						<%
							String sectionAddSucessMessage = (String) request.getAttribute("sectionAddSucessMessage");
							String sectionAddFailedMessage = (String) request.getAttribute("sectionAddFailedMessage");

							if (sectionAddSucessMessage != null) {
						%>

						
							<span style="align-content:center; color: green"><%=sectionAddSucessMessage%></span>
						...
						%>
							...
							<span style="align-content:center; color: red"><%=sectionAddFailedMessage%></span>
											...
											<div class="row clearfix">
												...
												<div class="col-lg-10 col-md-10 col-sm-8">
													<div class="form-group">
														<input name="sectionName" type="text" class="form-control"
												...
												<div class="col-lg-10 col-md-10 col-sm-8">
													<div class="form-group">
														<input name="maxQuestion" type="number"
															class="form-control" placeholder="eg. 10 / 25 /50">
													</div>
												</div>
											</div>
					...
					<div class="card">
						...
						<div class="body">
							<ul class="list-unstyled mb-0 widget-categories">
								<li><a href="addCategory.jsp">Add Section</a></li>
