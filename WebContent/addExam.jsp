			...
			<div class="row clearfix">
				<div class="col-lg-12">
					...
					<div class="card">
						...
						<%
							String examAddSucessMessage = (String) request.getAttribute("examAddSucessMessage");
							String examAddFailedMessage = (String) request.getAttribute("examAddFailedMessage");

							if (examAddSucessMessage != null) {
						%>

						
							<span style="align-content:center; color: green"><%=examAddSucessMessage%></span>
						...
						<%
							if (examAddFailedMessage != null) {
						%>

							<span style="align-content:center; color: red"><%=examAddFailedMessage%></span>
